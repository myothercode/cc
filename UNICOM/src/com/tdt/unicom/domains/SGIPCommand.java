...
public class SGIPCommand {
	...
	public void  write(OutputStream out) {
		...
		log.info("【" + Thread.currentThread().getName() + "发送SP "
				+ SGIPCommandDefine.getCommandName(this.header.getCommandId()) + "命令】,{长度="+this.header.getTotalmsglen()+",类型= "+SGIPCommand.Bytes4ToInt(this.header.getCommandId())+",序列="+this.header.getSequenceNumber()+"}");
	}
